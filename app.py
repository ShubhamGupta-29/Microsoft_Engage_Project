...
if __name__ == '__main__':
    ...
    st.text("") 
    st.markdown('''<h5 style='text-align: left; color: #0B114A;'>Made by Shubham Gupta</h5>''',
                    unsafe_allow_html=True) 
    st.markdown('''<h6 style='text-align: left; color: #0B114A;'>shubham.gupta29062002@gmail.com</h6>''',
                    unsafe_allow_html=True) 
    st.markdown('''<h6 style='text-align: left; color: #0B114A;'>github.com/ShubhamGupta-29/Microsoft_Engage_Project</h6>''',
                    unsafe_allow_html=True) 
